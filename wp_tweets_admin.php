...
<div class="wrap"><?php echo "<h2>" . __( 'WP Author\'s Tweets Options', 'tweets_opt' ) . "</h2>"; ?>
  ...
  <p>When using this plugin there are a variety of options you can choose from. You can either set add a different 'follow me' button and twitter feed for each author on your blog, or set a default username and count here to overwrite all authors profiles.</p>
